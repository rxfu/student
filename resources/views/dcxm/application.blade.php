...
@section('content')
<form id="appForm" name="appForm" method="post" action="{{ url('dcxm/xmsq') }}" class="form-horizontal">
    {!! csrf_field() !!}
    <section class="row">
        <div class="col-sm-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div>
                        <textarea id="xmjj" name="xmjj" class="form-control note" rows="20"></textarea>
                    </div>
                    ...
                    <div>
                        <textarea id="sqly" name="sqly" class="form-control" rows="20"></textarea>
                    </div>
                    ...
                    <div>
                        <textarea id="xmfa" name="xmfa" class="form-control" rows="20"></textarea>
                    </div>
                    ...
                    <div>
                        <textarea id="tscx" name="tscx" class="form-control" rows="20"></textarea>
                    </div>
                    ...
                    <div>
                        <textarea id="jdap" name="jdap" class="form-control" rows="20"></textarea>
                    </div>
                </div>
            </div>
        </div>
