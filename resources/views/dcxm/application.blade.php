        ...
        <div class="col-sm-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div>
                        <textarea id="sqly" name="sqly" class="form-control note" rows="20">{{ is_null($project->application) ? '' : $project->application->sqly }}</textarea>
                    </div>
                    ...
                    <div>
                        <textarea id="xmfa" name="xmfa" class="form-control note" rows="20">{{ is_null($project->application) ? '' : $project->application->xmfa }}</textarea>
                    </div>
                    ...
                    <div>
                        <textarea id="tscx" name="tscx" class="form-control note" rows="20">{{ is_null($project->application) ? '' : $project->application->tscx }}</textarea>
                    </div>
                    ...
                    <div>
                        <textarea id="jdap" name="jdap" class="form-control note" rows="20">{{ is_null($project->application) ? '' : $project->application->jdap }}</textarea>
                    </div>
                    ...
                    <div>
                        <textarea id="zmcl" name="zmcl" class="form-control note" rows="20">{{ is_null($project->application) ? '' : $project->application->zmcl }}</textarea>
                    </div>
                </div>
            </div>
        </div>
