...
Route::middleware('auth')->group(function () {
	Route::get('profile/register', 'ProfileController@showRegisterForm')->name('profile.register');
	...
	Route::middleware('register')->group(function () {
		...
		Route::get('selcourse/listing/{type}/{campus}', 'SelcourseController@listing')->where('type', 'pubsport|public|require|elect|human|nature|art|other|history4');
		Route::get('selcourse/{type}', ['as' => 'selcourse.show', 'uses' => 'SelcourseController@show'])->where('type', 'pubsport|public|require|elect|human|nature|art|other|history4');
